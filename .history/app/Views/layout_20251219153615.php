...
// If assets are not directly under document root, fall back to /public/assets (typical when docroot is the repo root).
if ($docRoot !== '' && !is_file($docRoot . '/assets/css/main.css')) {
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars($assetBase . '/assets/css/main.css', ENT_QUOTES, 'UTF-8'); ?>">
</head>
<body>
...
<script src="<?php echo htmlspecialchars($assetBase . '/assets/js/main.js', ENT_QUOTES, 'UTF-8'); ?>"></script>
</body>
</html>
