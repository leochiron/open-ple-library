...
<section class="toolbar">
    ...
    <div class="toolbar-actions">
        ...
        <a class="btn primary" href="<?php echo htmlspecialchars(buildUrl(['action' => 'download', 'path' => $relativePath]), ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><?php echo htmlspecialchars($i18n->t('file.download'), ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
</section>
