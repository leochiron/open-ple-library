    ...
    <?php if ($isPreviewable): ?>
        <div class="preview">
            <?php if (strpos($mime, 'pdf') !== false): ?>
                <iframe src="<?php echo htmlspecialchars(buildUrl(['action' => 'open', 'path' => $relativePath]), ENT_QUOTES, 'UTF-8'); ?>" title="PDF preview" loading="lazy"></iframe>
            <?php elseif (strpos($mime, 'audio') === 0): ?>
                <audio controls preload="metadata">
                    <source src="<?php echo htmlspecialchars(buildUrl(['action' => 'open', 'path' => $relativePath]), ENT_QUOTES, 'UTF-8'); ?>" type="<?php echo htmlspecialchars($mime, ENT_QUOTES, 'UTF-8'); ?>">
