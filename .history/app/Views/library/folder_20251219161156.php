        ...
        <div class="file-list" role="list">
            <div class="file-row file-row--head" role="listitem">
                ...
                <div class="file-row" role="listitem">
                    <div>
                        <?php if ($entry['is_dir']): ?>
                            <span class="pill pill-dir">📁 <?php echo htmlspecialchars($i18n->t('type.folder'), ENT_QUOTES, 'UTF-8'); ?></span>
                        <?php else: ?>
                            <?php
                            $ext = strtolower(pathinfo($entry['name'], PATHINFO_EXTENSION));
                            $icon = '📄';
                            $type = $i18n->t('type.file');
                            ...
                            ?>
                            <span class="pill pill-file"><?php echo $icon; ?> <?php echo htmlspecialchars($type, ENT_QUOTES, 'UTF-8'); ?></span>
                        <?php endif; ?>
