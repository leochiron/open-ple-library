            ...
            <?php foreach ($entries as $entry): ?>
                ...
                <div class="file-row" role="listitem" data-icon="<?php echo htmlspecialchars($icon, ENT_QUOTES, 'UTF-8'); ?>" data-name="<?php echo htmlspecialchars($entry['name'], ENT_QUOTES, 'UTF-8'); ?>">
                    <div>
                        ...
                        <a href="<?php echo htmlspecialchars($url, ENT_QUOTES, 'UTF-8'); ?>" class="file-name" target="_blank"><?php echo htmlspecialchars($entry['name'], ENT_QUOTES, 'UTF-8'); ?></a>
                    </div>
                    ...
                    <div class="actions">
                        <?php if ($entry['is_dir']): ?>
                            ...
                            <?php if ($config['branding']['allow_directory_download'] ?? true): ?>
                                <a class="btn ghost" href="<?php echo htmlspecialchars(buildUrl(['action' => 'download', 'path' => $entryPath]), ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><?php echo htmlspecialchars($i18n->t('file.download'), ENT_QUOTES, 'UTF-8'); ?></a>
                            <?php endif; ?>
                        <?php else: ?>
                            <?php if ($isPhp): ?>
                                <a class="btn ghost" href="<?php echo htmlspecialchars($url, ENT_QUOTES, 'UTF-8'); ?>" target="_blank"><?php echo htmlspecialchars($i18n->t('file.open'), ENT_QUOTES, 'UTF-8'); ?></a>
