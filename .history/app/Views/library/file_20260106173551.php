...
<section class="toolbar">
    ...
    <div class="toolbar-actions">
        ...
        <?php if ($isPhpFile): ?>
            <a class="btn primary" href="<?php echo htmlspecialchars(buildCleanUrl(['path' => $relativePath]), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($i18n->t('file.open'), ENT_QUOTES, 'UTF-8'); ?></a>
        <?php else: ?>
