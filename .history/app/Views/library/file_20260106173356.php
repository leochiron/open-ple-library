...
<section class="toolbar">
    ...
    <div class="toolbar-actions">
        ...
        <?php $isPhpFile = strtolower(pathinfo($filename, PATHINFO_EXTENSION)) === 'php'; ?>
        <?php if ($isPhpFile): ?>
            <a class="btn primary" href="<?php echo htmlspecialchars(buildCleanUrl(['action' => 'open', 'path' => $relativePath]), ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer"><?php echo htmlspecialchars($i18n->t('file.open'), ENT_QUOTES, 'UTF-8'); ?></a>
        <?php else: ?>
