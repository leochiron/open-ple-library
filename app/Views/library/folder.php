            ...
            <?php foreach ($entries as $entry): ?>
                ...
                <div class="file-row" role="listitem" data-icon="<?php echo htmlspecialchars($icon, ENT_QUOTES, 'UTF-8'); ?>" data-name="<?php echo htmlspecialchars($entry['name'], ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <div class="actions">
                        ...
                        <?php else: ?>
                            <?php
                            // Check if file is previewable (PDF, audio, video)
                            $isPreviewable = in_array($ext, ['pdf', 'mp3', 'wav', 'ogg', 'm4a', 'mp4', 'avi', 'mov', 'mkv', 'webm'], true);
                            $allowDownloadPreviewable = $config['branding']['allow_download_previewable'] ?? true;
                            ?>
                            <?php if ($isPhp): ?>
